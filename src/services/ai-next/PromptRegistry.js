...
export const PROMPT_REGISTRY = Object.freeze({
    ...
    globalImpact: {
        ...
        build: ({ mission, documents }) => [
            ...
            'Contrato estricto: risk e impact solo pueden ser low, medium o high; confidence debe ser un número JSON entre 0 y 1; cada elemento de affectedDocuments debe incluir documentId, impact, action, reason y evidence; evidence debe ser una cita literal exacta tomada del documento indicado. No reportes un documento como afectado si no puedes citar la evidencia. action solo puede ser modify, review, inform o ignore.',
    ...
    globalAlternatives: {
        ...
        build: ({ mission, impact, documents }) => [
            ...
            'Solo propón cambios sustentados por las citas verificadas de Impacto. Si Impacto no contiene documentos afectados con evidencia, no afirmes haber encontrado un problema ni propongas correcciones sobre hechos no citados.',
            SHARED_RULES,
            asContext('Misión', JSON.stringify(mission)),
